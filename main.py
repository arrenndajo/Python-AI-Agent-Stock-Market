...
@st.cache_resource
def load_model():
    DEEPSEEK_API_KEY = "sk-ffb042610f5b4302965d88b6b53f7489"
...
def create_stock_agent(llm):
    ...
    def extract_ticker(text):
        # Look for common stock ticker patterns (1-5 uppercase letters)
    ...
    with st.spinner('Analyzing...'):
        try:
            ...
            if "Insufficient Balance" in str(e):
                st.error("Error: Insufficient Balance. Please check your API key balance or upgrade your plan.")
            else:
                st.error(f"Error: {str(e)}")

st.markdown("---")
st.caption("Powered by LangChain, Deepseek, and Streamlit")
